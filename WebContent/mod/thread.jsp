...
<body>
	...
	<div class="row main-board">
			...
			<div class="row">
				<a href="./account-manager-action.do">
					<button type="button" class="btn btn-elegant button-side-menu-left">
						<i class="fa fa-group icon-in-button" aria-hidden="true"></i>Tài khoản
					</button>
				</a>
			</div>
		</div>
		<div class="col-lg-10 col-md-12 col-12 scroll-box">
			<div class="main-content hoverable" style="overflow-y: scroll;">
				...
				<html:form action="/mod/thread-manager-action" method="get">
	...
	<script type="text/javascript">
		...
		function verifyItem(id){
			...
			window.location.href = url + "/verify-thread-action.do?threadId="+id; 
		};
		//Hàm xóa item
